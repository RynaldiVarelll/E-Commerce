...
<div class="container mx-auto px-6 py-6 max-w-2xl">
    <div class="mb-10 text-center">
        <h1 class="text-4xl font-black text-gray-900 tracking-tight leading-none uppercase italic">
            Tambah <span class="text-blue-600">Pengguna.</span>
        </h1>
        <p class="text-gray-500 mt-2 font-medium">Daftarkan Seller atau Customer baru ke dalam sistem.</p>
    </div>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" 
        ...
        <div class="relative z-10">
            ...
            <div class="mb-10 flex flex-col items-center">
                ...
                <label class="block text-[10px] font-black uppercase tracking-[0.2em] text-blue-600">Unggah Foto Profil</label>
            ...
            <div class="mb-6">
                ...
                <select name="role" class="w-full bg-white/50 backdrop-blur-md border border-white/60 rounded-2xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-400/50 transition-all font-bold" required>
                    ...
                    <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>Seller (Penjual)</option>
                </select>
            ...
            <div class="flex items-center gap-4 pt-6 border-t border-white/40">
                <button type="submit" 
                    ...
                    <i class="fa-solid fa-user-plus mr-2"></i> TAMBAHKAN USER
                </button>
