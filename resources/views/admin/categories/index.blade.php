...
<div class="container mx-auto px-6 py-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
        <div>
            <h1 class="text-4xl font-black text-gray-900 dark:text-white tracking-tight leading-none uppercase italic">Kelola <span class="text-blue-600 dark:text-blue-400">Kategori.</span></h1>
            <p class="text-gray-500 dark:text-gray-400 mt-2 font-medium">Atur kategori produk secara terorganisir.</p>
        </div>
        <a href="{{ route('admin.categories.create') }}" 
            class="inline-flex items-center bg-blue-600 text-white px-6 py-3.5 rounded-2xl font-black shadow-xl shadow-blue-200 dark:shadow-none hover:bg-blue-700 transition-all active:scale-95 whitespace-nowrap">
                    ...
                    <tr class="hover:bg-white/40 dark:hover:bg-gray-800/40 transition-colors group">
                        <td class="px-8 py-6">
                            <div class="flex items-center">
                                <span class="font-black text-gray-900 dark:text-white">{{ $cat->name }}</span>
                            </div>
                        </td>
                        <td class="px-8 py-6 text-sm text-gray-500 dark:text-gray-400 font-medium">/{{ $cat->slug }}</td>
