    ...
    <div class="max-w-xl w-full relative z-10">
        <div class="bg-white rounded-[3rem] shadow-2xl shadow-gray-200/50 overflow-hidden transform transition-all duration-700 hover:scale-[1.01]">
            ...
            <div class="px-8 py-10">
                ...
                <p class="text-center mt-10 text-[10px] text-gray-400 font-black uppercase tracking-[0.2em]">
                    Butuh bantuan? <a href="#" class="text-blue-500 hover:underline">Hubungi Customer Support</a>
                </p>
            </div>
        </div>
    </div>
